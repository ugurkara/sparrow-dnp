...
public class DefaultFactory {
    ...
    public static MasterDeviceConfig createExampleMasterDeviceConfig() {
        ...
        for (int i = 0; i < 10; i++) {
            VariableConfig.DigitalOutputConfig digitalOutputConfig = new VariableConfig.DigitalOutputConfig(i);
            masterDeviceConfig.getMemoryUnits().get(4).getItems().add(digitalOutputConfig);
        }
    ...
    public static SlaveDeviceConfig createExampleSlaveDeviceConfig() {
        ...
        for (int i = 0; i < 10; i++) {
            VariableConfig.DigitalOutputConfig digitalOutputConfig = new VariableConfig.DigitalOutputConfig(i);
            slaveDeviceConfig.getMemoryUnits().get(4).getItems().add(digitalOutputConfig);
        }
